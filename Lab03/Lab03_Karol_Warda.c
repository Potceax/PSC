...
int GetInupt(char* text, char* format)
{
	int num;
	while (my_true) {
...
int main()
{
	...
	// Zad 20
	{
		...
		int number01 = GetInupt("Please type first integer: ", "%d");
		int number02 = GetInupt("Please type the second integer: ", "%d");
	...
	// Zad 21
	{
		...
		int number = GetInupt("Please write a number in base8 format: ", "%o");
		printf("The number in base10 is equal to: %d\n\n", number);	// Program prints garbage value if number is < 0
	...
	// Zad 22
	{
		...
		int number = GetInupt("Please write a number in base10 format: ", "%d");
		printf("The number in base16 is equal to: %x\n\n", number);	// Program prints garbage value if number is < 0
	...
	// Zad 23
	{
		...
		while (number <= 0) {
			number = GetInupt("Please write a number in base10 format (need to be positive): ", "%d");
			if (number <= 0)
	...
	// Zad 24
	{
		printf("Exercise 24\n\n");
		printf("Autor: Karol Warda\n");
		printf("This program prints your input as int and tell you if it's positive or negative.\n\n");

		int number = GetInupt("Please write a positive int type value: ", "%d");
		if (number < 0)
			printf("Number %d is not positive\n\n", number);
		else
			printf("Number %d is positive\n\n", number);

		printf("End of The exercise 24\n\n\n");
	}
